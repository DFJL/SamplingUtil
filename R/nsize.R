...
#'
#' Función para generar una muestra con control de error absoluto o relativo.
...
#' @export
#' @description Basado en slides del curso Tópicos de Muestreo.Universidad de Costa Rica.
